...
export const BUILTIN_GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  term({
    ...
    key: "pitch_usage_pct",
    label: "Usage %",
    aliases: ["usage", "usage %", "usage pct", "usage percent", "pitch usage", "pitch usage %", "pitch mix", "mix share"],
    plainDefinition: "Usage percentage shows how often a pitcher turns to a specific pitch relative to the rest of the arsenal.",
    whyItMatters: "It tells you which pitch shapes the attack plan and which offerings are secondary or matchup-specific looks.",
    advancedNotes: "Usage alone does not prove pitch quality, but it does reveal trust level and how often hitters should expect to see that pitch.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["Pitch mix", "Repertoire", "Pitching plan"],
  }),
  term({
    sport: "MLB",
    key: "velocity_mph",
    label: "Velocity",
    aliases: ["velo", "velocity mph", "mph", "average velocity"],
    plainDefinition: "Velocity is the average speed of a pitch in miles per hour.",
    whyItMatters: "Pitch speed affects reaction time, separation between offerings, and how well a pitch plays off the rest of the mix.",
    advancedNotes: "Velocity matters most when paired with shape, location, and usage. A modest velocity band can still play if the arsenal tunnels well.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["Pitch quality", "Stuff", "Arsenal context"],
  }),
  term({
    sport: "MLB",
    key: "pitches_strikes",
  ...
  term({
    ...
    key: "ppg",
    label: "PPG",
    aliases: ["points per game", "Scoring load", "scoring volume"],
  ...
  term({
    ...
    key: "rpg",
    label: "RPG",
    aliases: ["rebounds per game", "Rebounding load"],
  ...
  term({
    ...
    key: "apg",
    label: "APG",
    aliases: ["assists per game", "Playmaking load", "playmaking"],
  ...
  term({
    ...
    key: "nba_rest_days",
    label: "Rest days",
    aliases: ["days of rest", "rest advantage"],
    plainDefinition: "Rest days is the number of full days a team has between games.",
    whyItMatters: "More rest usually means fresher legs, especially for veteran rosters and back-to-back heavy stretches.",
    direction: "HIGHER_IS_BETTER",
    tags: ["schedule", "rest"],
  }),
  term({
    sport: "NBA",
    key: "nba_game_density",
    label: "Game density",
    aliases: ["schedule density", "games in 7 days", "back-to-back"],
    plainDefinition: "Game density measures how many games are packed into a rolling 7-day window.",
    whyItMatters: "Teams playing 3 or more games in 7 days face compounding fatigue — shot quality and defensive effort both dip.",
    direction: "LOWER_IS_BETTER",
    tags: ["schedule", "fatigue"],
  }),
  term({
    sport: "NBA",
    key: "nba_travel_path",
    label: "Travel path",
    aliases: ["travel stress", "road trip", "coast to coast"],
    plainDefinition: "Travel path describes the home/away pattern and coast-to-coast travel load going into a game.",
    whyItMatters: "Cross-country travel the day before a game is consistently linked to reduced first-half energy and slower rotations.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["schedule", "travel"],
  }),
  term({
    sport: "NBA",
    key: "nba_shot_profile",
    label: "Shot Profile",
    aliases: ["shot diet", "shot distribution", "attempt distribution"],
    plainDefinition: "Shot profile describes where and how a team generates its attempts — at the rim, mid-range, or from three.",
    whyItMatters: "A team that creates shots at the rim or from three typically operates more efficiently than one reliant on mid-range volume.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["offense", "shooting"],
  }),
  term({
    sport: "NBA",
    key: "nba_offensive_glass",
    label: "Offensive Glass",
    aliases: ["offensive rebounding", "second-chance points", "OREB rate"],
    plainDefinition: "Offensive glass refers to offensive rebounding rate — how often a team recaptures its own misses.",
    whyItMatters: "Second-chance possessions are almost free offense. Teams that crash the glass can offset shot-quality disadvantages.",
    direction: "HIGHER_IS_BETTER",
    tags: ["rebounding", "offense"],
  }),
  term({
    sport: "NBA",
    key: "nba_turnover_battle",
    label: "Turnover Battle",
    aliases: ["turnover rate", "possession protection", "turnover discipline"],
    plainDefinition: "Turnover battle measures which team better protects the ball — fewer turnovers means more shot attempts.",
    whyItMatters: "Possession discipline is a force multiplier: every turnover prevented is a free possession the opponent did not earn.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["possession", "defense"],
  }),
  term({
    sport: "NBA",
    key: "nba_paint_touches",
    label: "Paint Touches",
    aliases: ["paint pressure", "rim pressure", "drives"],
    plainDefinition: "Paint touches count how often a team generates dribble penetration, post-ups, or cuts into the restricted area.",
    whyItMatters: "Interior pressure forces help rotations. When defenses collapse it creates open corner threes and free throw opportunities.",
    direction: "HIGHER_IS_BETTER",
    tags: ["offense", "interior"],
  }),
  term({
    sport: "NBA",
    key: "nba_halfcourt_efficiency",
    label: "Half-Court Efficiency",
    aliases: ["half court", "set play efficiency", "halfcourt offense"],
    plainDefinition: "Half-court efficiency rates how well a team scores in set-play situations when the defense is fully set.",
    whyItMatters: "Playoff basketball slows down. Teams that can execute in the half court survive elimination games — transition teams often struggle.",
    direction: "HIGHER_IS_BETTER",
    tags: ["offense", "execution"],
  }),
  term({
    sport: "NBA",
    key: "nba_turnover_pressure",
    label: "Turnover Pressure",
    aliases: ["deflections", "forced turnovers", "active hands"],
    plainDefinition: "Turnover pressure measures how often a team forces live-ball turnovers through deflections, steals, and activity.",
    whyItMatters: "Forced turnovers create fast break opportunities and disrupt offensive rhythm. High-pressure defenses can tilt momentum quickly.",
    direction: "HIGHER_IS_BETTER",
  ...
  term({
    ...
    key: "nba_minutes",
    label: "Minutes",
    aliases: ["minutes played", "MIN", "playing time"],
    plainDefinition: "Minutes played tracks average time on the floor per game. It is the primary usage signal for role assessment.",
    whyItMatters: "A player logging 30+ minutes is a core rotation piece; sub-20 minutes usually means a situational or backup role.",
    direction: "CONTEXT_DEPENDENT",
    tags: ["role", "usage"],
  }),
  term({
